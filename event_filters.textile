...
* filter which unsynced / unreplicaed differences should be processed by rubyrep
...
The following simple example configures rubyrep to sync / replicate only accounts with column 'id' < 100:
