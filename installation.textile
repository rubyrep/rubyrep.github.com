...
Pre-condition: Java is installed (tested with version 1.6; version 1.5 might also work).

# Download the latest JRuby rubyrep package from "Rubyforge":http://rubyforge.org/frs/?group_id=7932.
  (There are different files available. Choose the ZIP package.)
# Unzip
# Done
