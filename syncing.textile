...
* @config.include_tables 'dept', :left_record_handling => :ignore, :right_record_handling => :ignore, :sync_conflict_handling => :update_left@
...
Go to the "configuration reference":configuration_reference.html to see a list of all available configuration options.
